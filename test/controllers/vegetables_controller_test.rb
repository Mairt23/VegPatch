...
class VegetablesControllerTest < ActionController::TestCase
  ...
  test "should create vegetable" do
    assert_difference('Vegetable.count') do
      post :create, vegetable: { description: @vegetable.description, easiness_to_grow_rating: @vegetable.easiness_to_grow_rating, instructions: @vegetable.instructions, name: @vegetable.name, tips: @vegetable.tips }
    end
  ...
  test "should update vegetable" do
    patch :update, id: @vegetable, vegetable: { description: @vegetable.description, easiness_to_grow_rating: @vegetable.easiness_to_grow_rating, instructions: @vegetable.instructions, name: @vegetable.name, tips: @vegetable.tips }
    assert_redirected_to vegetable_path(assigns(:vegetable))
  end
